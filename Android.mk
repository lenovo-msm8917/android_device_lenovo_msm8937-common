...
ifneq ($(filter TB8504X TB8504F TBX304F TBX304X,$(TARGET_DEVICE)),)
...
ALL_DEFAULT_INSTALLED_MODULES += $(RFS_MSM_ADSP_SYMLINKS) $(RFS_MSM_MPSS_SYMLINKS) $(RFS_APQ_GNSS_SYMLINKS) $(RFS_MSM_SLPI_SYMLINKS)
